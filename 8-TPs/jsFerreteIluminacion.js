...
function CalcularPrecio () 
{
  ...
  if(cantidad==4&&lamparas=="ArgentinaLuz"||cantidad==4&&lamparas=="FelipeLamparas")
  {
    precio = cantidad*precioUnitario;
    descuento = 0.75;
    precioDescuento = precio*descuento;
  ...
  if(cantidad==4&&lamparas=="JeLuz"||cantidad==4&&lamparas=="Osram"||cantidad==4&&lamparas=="HazIluminacion")
  {
    precio = cantidad*precioUnitario;
    descuento = 0.8;
    precioDescuento = precio*descuento;
  ...
  if(cantidad==3&&lamparas=="JeLuz"||cantidad==3&&lamparas=="HazIluminacion"||cantidad==3&&lamparas=="Osram")
  {
    precio = cantidad*precioUnitario;
    descuento = 0.95;
    precioDescuento = precio*descuento;
